    ...
    <div className="container mx-auto grid md:grid-cols-4 gap-12 mb-12">
      ...
      <div className="md:col-span-2">
        <div className="flex items-center gap-2 mb-4">
          <div className="w-10 h-10 rounded-full border border-orange-500 overflow-hidden">
             <img src="/logo.png" alt="Logo" className="w-full h-full object-cover" onError={(e) => { e.target.onerror = null; e.target.src="/logo.jpg"; }} />
          </div>
          <span className="text-2xl font-black tracking-wider text-white">FIRE HIVE</span>
        </div>
        ...
        <div className="flex gap-4">
          <a href="#" className="bg-zinc-900 p-2 rounded-full text-gray-400 hover:bg-orange-600 hover:text-white transition"><Facebook size={20}/></a>
          <a href="#" className="bg-zinc-900 p-2 rounded-full text-gray-400 hover:bg-pink-600 hover:text-white transition"><Instagram size={20}/></a>
          <a href="#" className="bg-zinc-900 p-2 rounded-full text-gray-400 hover:bg-blue-600 hover:text-white transition"><Twitter size={20}/></a>
          <a href="#" className="bg-zinc-900 p-2 rounded-full text-gray-400 hover:bg-blue-800 hover:text-white transition"><Linkedin size={20}/></a>
        </div>
      </div>
      ...
      <div>
        ...
        <ul className="space-y-2 text-gray-400 text-sm">
          ...
          <li><Link to="/events" className="hover:text-orange-500 transition">Projects & Events</Link></li>
          <li><Link to="/give" className="hover:text-orange-500 transition">Partner With Us</Link></li>
          <li><Link to="/portal" className="hover:text-orange-500 transition">Member Portal</Link></li>
          <li><Link to="/start-chapter" className="hover:text-orange-500 transition">Start a Chapter</Link></li>
        </ul>
      </div>
      ...
      <div>
        ...
        <ul className="space-y-4 text-gray-400 text-sm">
          <li className="flex items-start gap-3"><MapPin size={18} className="text-orange-500 shrink-0 mt-1"/> <span>Minna, Niger State,<br/>Nigeria.</span></li>
          <li className="flex items-center gap-3"><Mail size={18} className="text-orange-500 shrink-0"/> <span>hello@firehivenetwork.com</span></li>
          <li className="flex items-center gap-3"><Phone size={18} className="text-orange-500 shrink-0"/> <span>+234 812 345 6789</span></li>
          <li className="flex items-center gap-3"><Clock size={18} className="text-orange-500 shrink-0"/> <span>Mon - Fri: 9AM - 5PM</span></li>
        </ul>
      </div>
    </div>
    <div className="text-center text-zinc-600 text-xs pt-8 border-t border-zinc-900">
      <p>&copy; 2025 Fire Hive Network Int'l. All Rights Reserved.</p>
    </div>
  </footer>
);

// --- NEW COMPONENT: 404 PAGE ---
const NotFoundPage = () => (
  <div className="min-h-screen bg-black flex flex-col items-center justify-center text-center p-4">
    <div className="bg-zinc-900/50 p-8 rounded-full mb-6 border border-zinc-800">
      <AlertTriangle size={64} className="text-orange-500" />
    </div>
    <h1 className="text-6xl font-black text-white mb-2">404</h1>
    <h2 className="text-2xl font-bold text-gray-300 mb-6">Lost in the Wilderness?</h2>
    <p className="text-gray-500 mb-8 max-w-md">The page you are looking for doesn't exist or has been moved. Let's get you back to the Hive.</p>
    <Link to="/" className="bg-orange-600 text-white px-8 py-3 rounded-full font-bold hover:bg-orange-500 transition">Return Home</Link>
  </div>
);
  ...
  <div className="min-h-screen bg-black pt-28 pb-12 px-4 relative">
    <div className="container mx-auto max-w-5xl relative z-10">
      ...
      <Reveal delay={200}>
        <div className="bg-zinc-900/80 p-8 rounded-2xl border border-zinc-700 mb-16">
          <p className="text-xl md:text-2xl text-gray-200 leading-relaxed">
            <span className="text-orange-500 font-bold">Fire Hive Network Int'l</span> is not just an organization; it is a spiritual ecosystem designed to raise, mentor, and position a generation of young people to take over systems and sectors for the Kingdom of God.
          </p>
        </div>
      </Reveal>
      ...
      <div className="grid md:grid-cols-3 gap-6 mb-16">
        <Reveal delay={300}>
          <div className="bg-zinc-900 p-6 rounded-xl border-t-4 border-red-500 h-full">
            <Flame className="text-red-500 w-10 h-10 mb-4"/>
            <h3 className="text-xl font-bold text-white mb-2">Dominance</h3>
            <p className="text-gray-400 text-sm">We don't just participate; we take over. Our mandate is to infiltrate every sector with Kingdom culture.</p>
          </div>
        </Reveal>
        <Reveal delay={400}>
          <div className="bg-zinc-900 p-6 rounded-xl border-t-4 border-orange-500 h-full">
            <Shield className="text-orange-500 w-10 h-10 mb-4"/>
            <h3 className="text-xl font-bold text-white mb-2">Excellence</h3>
            <p className="text-gray-400 text-sm">We believe that excellence is the language of kings. We do everything with the highest standard.</p>
          </div>
        </Reveal>
        <Reveal delay={500}>
          <div className="bg-zinc-900 p-6 rounded-xl border-t-4 border-blue-500 h-full">
            <Users className="text-blue-500 w-10 h-10 mb-4"/>
            <h3 className="text-xl font-bold text-white mb-2">Family</h3>
            <p className="text-gray-400 text-sm">We are a hive. We protect, support, and grow together. No soldier is left behind.</p>
          </div>
        </Reveal>
      </div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="text-center group">
            <div className="w-40 h-40 mx-auto rounded-full overflow-hidden border-2 border-zinc-700 mb-4 group-hover:border-orange-500 transition">
              <img src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400&q=60" alt="Leader" className="w-full h-full object-cover grayscale group-hover:grayscale-0 transition duration-500"/>
            </div>
          ...
          <div className="text-center group">
             <div className="w-40 h-40 mx-auto rounded-full overflow-hidden border-2 border-zinc-700 mb-4 group-hover:border-orange-500 transition">
               <img src="https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=400&q=60" alt="Leader" className="w-full h-full object-cover grayscale group-hover:grayscale-0 transition duration-500"/>
             </div>
             <h3 className="text-white font-bold text-lg">Sarah Oyeleke</h3>
             <p className="text-orange-500 text-sm font-bold uppercase">Director of Ops</p>
          </div>
          {/* Leader 3 */}
          <div className="text-center group">
             <div className="w-40 h-40 mx-auto rounded-full overflow-hidden border-2 border-zinc-700 mb-4 group-hover:border-orange-500 transition">
               <img src="https://images.unsplash.com/photo-1560250097-0b93528c311a?w=400&q=60" alt="Leader" className="w-full h-full object-cover grayscale group-hover:grayscale-0 transition duration-500"/>
             </div>
             <h3 className="text-white font-bold text-lg">Audrey Kpur</h3>
...
// --- UPGRADED EVENTS PAGE (With Past Gallery) ---
const EventsPage = () => {
  const events = [
  ...
  return (
    <div className="min-h-screen bg-black pt-28 pb-12 px-4">
      <div className="container mx-auto max-w-5xl">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-20">
          {events.map((event, i) => (
            <Reveal key={event.id} delay={i * 100}>
              <div className={`bg-zinc-900 rounded-xl overflow-hidden border-t-4 ${event.color} shadow-lg relative group hover:bg-zinc-800 transition`}>
                <div className="h-64 bg-zinc-800 relative overflow-hidden">
                  <img src={event.img} alt={event.title} className="w-full h-full object-cover group-hover:scale-105 transition duration-500" onError={(e) => {if (!event.img.startsWith('http')) e.target.style.display='none'; }} />
        ...
        {/* NEW: PAST EXPLOITS GALLERY */}
        <Reveal>
           <h2 className="text-3xl font-black text-white text-center mb-8 border-t border-zinc-900 pt-12">PAST EXPLOITS</h2>
           <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <div className="h-40 rounded-lg overflow-hidden bg-zinc-800"><img src="https://images.unsplash.com/photo-1523580494863-6f3031224c94?w=400&q=60" className="w-full h-full object-cover hover:scale-110 transition duration-700"/></div>
              <div className="h-40 rounded-lg overflow-hidden bg-zinc-800"><img src="https://images.unsplash.com/photo-1511632765486-a01980e01a18?w=400&q=60" className="w-full h-full object-cover hover:scale-110 transition duration-700"/></div>
              <div className="h-40 rounded-lg overflow-hidden bg-zinc-800"><img src="https://images.unsplash.com/photo-1529070538774-1843cb3265df?w=400&q=60" className="w-full h-full object-cover hover:scale-110 transition duration-700"/></div>
              <div className="h-40 rounded-lg overflow-hidden bg-zinc-800"><img src="https://images.unsplash.com/photo-1475721027766-f6b94c25afcb?w=400&q=60" className="w-full h-full object-cover hover:scale-110 transition duration-700"/></div>
           </div>
        </Reveal>
      </div>
    </div>
